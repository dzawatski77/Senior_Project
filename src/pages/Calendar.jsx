...
const Calendar = () => {
  return (
    <div className="m-2 md:m-10 mt-24 p-2 md:p-10 dark:text-gray-200 dark:bg-main-dark-bg bg-white rounded-3xl">
      <Header category="App" title="Calendar" />
      <ScheduleComponent hieght="250px" width="100%" eventSettings={{dataSource: scheduleData }} >
